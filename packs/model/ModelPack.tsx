...
import { Box, Layers, Activity, Scissors, Search, RotateCcw, Maximize, Plus, Minus, Play, Pause, ChevronRight, ArrowUpRight, Focus, Eye, Tag, Download, BookOpen, X, MousePointer2, Check, Copy, Wrench, Stethoscope } from 'lucide-react';
